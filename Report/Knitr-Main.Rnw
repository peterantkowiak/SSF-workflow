...
\centering
\includegraphics[width=0.4\textwidth]{cor_1.pdf}
\caption{Testing for correlation of the observed turning angle and step length. The y-axis shows the difference in the turning angle. The shape indicates a correlation for longer steps and doing only smal turning angles (around 1).}
\label{fig:cor_1}
\end{figure}
