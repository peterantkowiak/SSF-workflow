...
\noindent Given your final bursts we now randomly draw angles and distances from your observed data to get random steps. The angle is taken from the previous observed position111111111 your starting point of the random step while the distance is taken from the starting point to the next observed position. This means that each burst should at least contain of three observed positions. 
...
plot(mydata$ruggednessResc, mydata$wruggforest, main="GLMM predictions for ruggedness", type="l", col="darkgreen", lwd=2, ylim=c(0,1), xlim=c(0,250), xlab="ruggedness", ylab="W")
...
plot(mydata$ruggedness,mydata$wruggforest, main="MCLOGIT predictions for ruggedness", type="l", col="darkgreen", lwd=2, ylim=c(0,1), xlab="ruggedness", ylab="W")
lines(mydata$ruggedness,mydata$wruggopen,type="l", col="green", lwd=2)
#abline(h=1,lty=2,col="wheat4")
