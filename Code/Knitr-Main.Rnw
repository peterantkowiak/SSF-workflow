...
This section explains why the rest of this document exists.
...
\centering
\includegraphics[width=0.6\textwidth]{Leiocephalus-personatus-maskenleguan.jpg} %figure from Wikipedia
\caption{\emph{Leiocephalus personatus} is a species of curly-tailed lizard first described by Edward Drinker Cope in 1862. This specimen was photographed in the reptile zoo of Neu-Ulm, Germany. \small{\url{http://en.wikipedia.org/wiki/Template:POTD/2014-08-27}}}
\label{fig:lizard}
\end{figure}
